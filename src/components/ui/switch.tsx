  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        variant === "status"
          ? "data-checked:bg-success data-unchecked:bg-destructive"
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          variant === "status" ? "bg-white" : "bg-background dark:data-checked:bg-primary-foreground dark:data-unchecked:bg-foreground"
        )}
      />
    </SwitchPrimitive.Root>
  )
